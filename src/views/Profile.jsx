...
function Profile() {
    ...
    return (
        <>
            <div className='border p-3 shadow rounded-lg bg-white flex flex-col justify-between mx-auto w-[40rem]'>
                <div className='p-3 '>
                    <h3 className='text-blue-700 text-lg text-center font-semibold uppercase pb-2 line-clamp-2'>{user.name}</h3>
                    <div className='flex items-center gap-2 my-2'>
                        <h4 className='text-xl font-bold'>Emial: <span className='font-semibold px-2.5 py-0.5 rounded'>{user.email}</span></h4>
                    </div>
                    <div className='flex flex-col  mb-4 gap-1'>
                        <h4 className='text-base'>Address: <span className="font-semibold px-2.5 py-0.5 rounded">{user.shipping_address}</span></h4>
                        <h4 className='text-base'>Phone: <span className="font-semibold px-2.5 py-0.5 rounded">{user.phone}</span></h4>
                    </div>
                    <button
                        type='button'
