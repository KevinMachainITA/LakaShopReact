        ...
        <aside className="fixed top-0 left-0 z-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
                <ul className="space-y-2 font-medium">
                    <li>
                        <h1 className="flex items-center p-2 rounded-lg text-white">
                            <span>Dashboard</span>
                        </h1>
                    ...
                    <li>
                        <Link to='/admin/products' className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                ...
                <button 
                    type='button'
                    className='my-4 w-full rounded border-2 border-danger px-6 pb-[6px] pt-2 text-xs text-white font-medium uppercase leading-normal text-danger transition duration-500 ease-in-out hover:border-danger-600 focus:border-danger-600 focus:text-danger-600 focus:outline-none focus:ring-0 active:border-danger-700 active:text-danger-700 hover:text-black hover:bg-white hover:scale-110'
                    onClick={logout}
                    >
                    Logout
                </button>
